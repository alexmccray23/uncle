...
function M.splitBase()
  ...
  local choices = {
    ...
    { case = "C//F", question = "VERSION2", code = "3,6" },
    { case = "D//E", question = "VERSION2", code = "4,5" },
    { case = "G", question = "VERSION3", code = "7" },
    { case = "H", question = "VERSION3", code = "8" },
    { case = "I", question = "VERSION3", code = "9" },
  }
  M.processChoice(sample, choices)
end

function M.splitBaseKGS()
  local sample = vim.fn.input("Which split sample? (A, B, C, 'D,F', etc): "):upper():gsub(",", "//")
  local choices = {
    { case = "A", question = "VERSION ", code = "1" },
    { case = "B", question = "VERSION ", code = "2" },
    { case = "C", question = "VERSION2", code = "1" },
    { case = "D", question = "VERSION2", code = "2" },
    { case = "E", question = "VERSION2", code = "3" },
    { case = "F", question = "VERSION2", code = "4" },
    { case = "C//E", question = "VERSION2", code = "1,3" },
    { case = "D//F", question = "VERSION2", code = "2,4" },
    { case = "C//F", question = "VERSION2", code = "1,4" },
    { case = "D//E", question = "VERSION2", code = "2,3" },
    { case = "G", question = "VERSION3", code = "1" },
    { case = "H", question = "VERSION3", code = "2" },
    { case = "I", question = "VERSION3", code = "3" },
  }
  M.processChoice(sample, choices)
end

function M.processChoice(sample, choices)
...
vim.api.nvim_create_user_command("SplitBaseKGS", M.splitBaseKGS, {})
